    	...
    	{*/
            ...
            ->get();*/
			    ...
			    ->select(
			        ...
			        'employee_master.salary',
			        'employee_master.balance_cl',
			        DB::raw("SUM(CASE WHEN attendence_master.day = '3' OR attendence_master.end_date_time IS NULL THEN 1 ELSE 0 END) as total_absent"),
			        DB::raw("SUM(CASE WHEN attendence_master.day = '2' THEN 1 ELSE 0 END) as total_half_day"),
			        DB::raw("SUM(CASE WHEN attendence_master.day = '2' THEN 0.5 ELSE 0 END) as half_day"),
    	...
    	try{
    	 ...
    	 if($data)
    	 {
    	 	...
    	 	foreach ($detail as $key => $value) 
    	 	{
				...
				$Employee->balance_cl = $value->Rem + 1; // Ensure balance does not go negative
