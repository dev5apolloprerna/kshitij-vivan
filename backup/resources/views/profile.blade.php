                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                            name="first_name" placeholder="First Name" maxlength="20"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                            name="last_name" placeholder="Last Name" maxlength="20"
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="password" name="current_password"
                                            ...
                                            placeholder="Current Password" minlength="4" maxlength="20" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="password" name="new_password"
                                            class="form-control @error('new_password') is-invalid @enderror" minlength="4" maxlength="20" required
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="password" name="new_confirm_password"
                                            class="form-control @error('new_confirm_password') is-invalid @enderror" minlength="4" maxlength="20"
