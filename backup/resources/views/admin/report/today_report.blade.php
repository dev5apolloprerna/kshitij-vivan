                ...
                <div class="col-xxl-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button onclick="genrateToexcel()" type="button" class="btn btn-sm btn-primary">
                                        Export to Excel
                                </button>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <table id="scroll-horizontal" class="table nowrap align-middle"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($today as $today_report)
                                                                    ...
                                                                    <td>{{ number_format($today_report->start_latitude,2) }}</td>
                                                                    <td>{{ number_format($today_report->start_longitude,2) }}</td>
                                                                    ...
                                                                    <td>{{ number_format($today_report->end_latitude ,2)?? '-' }}</td>
                                                                    <td>{{ number_format($today_report->end_longitude,2) ?? '-' }}</td>
                                                                    <td>{{ $today_report->end_address ?? '-' }}</td>
                                                                    <td>@if($today_report->day == 1 && $today_report->start_date_time != null && $today_report->end_date_time != null)
                                                                        {{ 'P' }}
...
<script>
    function getEditData(id) {
            var url = "{{ route('report.edit_attendance', ':id') }}";
    ...
    {
        var Url = "{{route('report.export_today')}}";
