        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ route('home') }}" class="logo logo-dark">
                        <span class="logo-lg">
                            <img src="{{ asset ('assets/frontassets/images/logo.png')}}" alt="" height="100">
                        </span>
                    </a>
                </div>    
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                $session2 = Auth::guard('web_employees')->user()->empid;
                                $role2 = App\Models\Employee::select('employee_master.empid', 'roles.name')
                                ->where('employee_master.empid', $session2)
