    ...
    @foreach ($data as $metaData)
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="{{ route('metaData.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <div class="form-group {{ $errors->has('pagename') ? 'has-error' : '' }} mb-2">
                                ...
                                <input type="text" id="pagename" name="pagename" class="form-control"
                                    value="{{ old('pagename', isset($metaData) ? $metaData->pagename : '') }}" readonly>
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <div class="form-group {{ $errors->has('metaTitle') ? 'has-error' : '' }} mb-2">
                                ...
                                <input type="text" id="metaTitle" name="metaTitle" class="form-control"
                                    value="{{ old('metaTitle', isset($metaData) ? $metaData->metaTitle : '') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <div class="form-group {{ $errors->has('metaKeyword') ? 'has-error' : '' }} mb-2">
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="form-group {{ $errors->has('metaDescription') ? 'has-error' : '' }} mb-2">
                  ...
                  <div class="card-footer mt-5" style="text-align: right;">
                        ...
                        <a class="btn btn-primary float-right mr-3 mb-3 mx-2"
                            href="{{ route('metaData.index') }}">Cancel</a>
                    </div>
                </form>
                </div>
            </div>
