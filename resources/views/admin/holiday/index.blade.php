                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="live-preview">
                                            <form method="POST" action="{{ route('holiday.store') }}" autocomplete="off"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                            placeholder="Enter Name" maxlength="50" autocomplete="off"
                                                            autofocus required>
                                                    @if($errors->has('name'))
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <input  class="form-control" name="date" type="date" autocomplete="off" required>
                                                    </div>
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($holiday as $data)
                                                    <tr class="text-center">
                                                        <td>{{ $i + $holiday->perPage() * ($holiday->currentPage() - 1) }}
                                                        </td>
                                                        <td>{{ $data->name }}</td>
                ...
                <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('holiday.update') }}" autocomplete="off"
                                enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST" action="{{ route('holiday.delete') }}">
                                        @csrf
                                        @method('DELETE')
