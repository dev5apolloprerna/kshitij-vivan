                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="d-flex justify-content-between card-header">
                                            <h5 class="card-title mb-0">Add News </h5>
                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="title"
                                                            placeholder="Enter Title" maxlength="50" autocomplete="off"
                                                            autofocus required>
                                                    @if($errors->has('title'))
                                        ...
                                        <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($news as $data)
                                                    <tr class="text-center">
                                                        <td>{{ $i + $news->perPage() * ($news->currentPage() - 1) }}
                                                        </td>
                                                        <td>{{ $data->title }}</td>
                                                        <td> @if($data->photo == '')
                                                            <img src="{{ asset('assets/images/noImage.png')}}" width="50px" height="50px">
                                                            @else
                                                                <img src="{{ asset('/News/').'/'.$data->photo}}" width="50px" height="50px" >
                                                            @endif
                                                        </td>
                                                <td>{{ date('d-m-Y',strtotime($data->created_at)) }}</td>
                                                        ...
                                                        <td>
                                                            <div class="gap-2">
                                                                <a class="mx-1"  href="#" data-bs-toggle="modal" data-bs-target="#viewModal_{{$data->id}}" title="View">
                                    ...
                                    <div class="modal fade flip" id="viewModal_{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                        aria-hidden="true">
                ...
                <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('news.update') }}" autocomplete="off"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <span style="color:red;">*</span>Title
                                        <input type="text" class="form-control" name="title" id="EditstrName"
                                            placeholder="Enter Title" maxlength="50" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3">
                                        <span style="color:red;"></span>Photo
                                    ...
                                    <div class="mb-3">
                                        <span style="color:red;"></span>Description
                                        <textarea  class="form-control" name="description" id="editdescription" cols="10"></textarea>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form id="user-delete-form" method="POST" action="{{ route('news.delete') }}">
                                        @csrf
                                        @method('DELETE')
                ...
                $.ajax({
                    ...
                    success: function(data) 
                    {
                        ...
                        if(obj.photo == null)
                        {
                            ...
                            var imageUrl="/News/"+obj.photo;
                        }

                        $("#EditstrName").val(obj.title);
                        $('#id ').val(id);
